...
#define MSG_RX_PIN 					GPIO_Pin_11
#define MSG_TX_PIN					GPIO_Pin_10
#define MSG_PORT					GPIOB
#define MSG_UART					USART3

#define ENABLE_MSG_UART()			RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3, ENABLE);

#define MSG_UART_IRQ_CHANNEL		USART3_IRQn
#define MSG_UART_IRQ				USART3_IRQHandler

#define ENABLE_UART_DMA()			RCC_AHBPeriphClockCmd(RCC_AHBPeriph_DMA1, ENABLE);
#define MSG_Tx_DMA		       		DMA1
#define MSG_Tx_DMA_Channel    		DMA1_Channel2
#define MSG_Tx_DMA_FLAG       		DMA1_FLAG_TC2
#define MSG_Tx_DMA_CLEAR_FLAG		DMA1_FLAG_GL2
...
int32_t GetMessageUart3BufLength(void)
{
...
const StIOTCB c_stUart3IOTCB = 
{
	MessageUart3Init,
	MessageUart3Flush,
	MessageUart3Release,
	MessageUart3ReleaseNoReleaseData,
	GetMessageUart3BufLength,
	MessageUart3Write,
};
