...
#define MSG_WR_CTRL_PIN				GPIO_Pin_1
#define MSG_WR_CTRL_PORT			GPIOB

#define WR_CTRL_WRITE()				{MSG_WR_CTRL_PORT->BSRR = MSG_WR_CTRL_PIN;}
#define WR_CTRL_READ()				{MSG_WR_CTRL_PORT->BRR = MSG_WR_CTRL_PIN;}
...
static void UARTInit(void)
{
	...
	USART_InitStructure.USART_BaudRate = 4800;//g_u32Bandrate;
